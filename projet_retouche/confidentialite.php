    ...
    <div class="container">
      ...
      <ul>
          <li>
              ...
              <b>« Service »</b>). Elle présente également vos options concernant la collecte et l’utilisation de vos données
              personnelles.
          </li>
          <li>
              ...
              <b>Contenu d’utilisateur</b> ») sur le Service et vous acceptez de partager ce Contenu d’utilisateur publiquement.
          ...
          <li>
              ...
              <b>Personnes qui utilisent le Service</b> »).
          </li>
      </ul>
      ...
      <p>
          <b>Informations que vous nous fournissez directement :</b>
      </p>
      ...
      <p>
          <b>Retrouver vos amis sur U'Connect :</b>
      </p>
      ...
      <ul>
          ...
          <li>
              <b>Remarque sur la fonctionnalité Invitez vos amis :</b> si vous choisissez d’inviter une personne sur le Service
      ...
      <p>
          <b>Informations des fichiers journaux :</b>
      </p>
      ...
      <p>
          <b>Identificateurs de périphériques :</b>
      </p>
      ...
      <h2>2. UTILISATION DE VOS DONNÉES PERSONNELLES</h2>

      <p> En plus des cas d’utilisation spécifiques décrits dans la présente Politique de confidentialité, il est possible que
          nous utilisions les données que nous recevons aux fins suivantes : </p>
      ...
      <h2>3. PARTAGE DE VOS DONNÉES PERSONNELLES</h2>

      <p> Nous nous engageons à ne pas louer ni vendre vos données personnelles à des tiers externes à U'Connect (ou au groupe
          de sociétés dont U'Connect fait partie) sans votre consentement, sauf disposition contraire énoncée dans la présente
          Politique. </p>
      <p>
          <b>Tiers avec lesquels nous pouvons partager vos données personnelles :</b>
      </p>
      ...
      <p>
          <b>Tiers avec lesquels vous pouvez choisir de partager votre Contenu d’utilisateur :</b>
      </p>
      ...
      <p>
          <b>Scénario en cas de changement de propriétaire :</b>
      </p>
      ...
      <p>
          <b>Réponse à des requêtes judiciaires et prévention de tout risque de dommage :</b>
      </p>
      ...
      <h2>4. STOCKAGE DE VOS DONNÉES PERSONNELLES</h2>

      <p>
          <b>Stockage et traitement :</b>
      </p>
      ...
      <h2>5. VOS CHOIX CONCERNANT VOS DONNÉES PERSONNELLES</h2>

      <p>
          <b>Informations sur votre compte et paramètres de profil/confidentialité :</b>
      </p>
      ...
      <p>
          <b>Durée de conservation de votre Contenu d’utilisateur :</b>
      </p>
      ...
      <h2>6. PROTECTION DE LA VIE PRIVÉE DES ENFANTS</h2>

      <p> U'Connect ne collecte ni ne sollicite intentionnellement de données personnelles concernant des personnes âgées de moins
      ...
      <h2>7. AUTRES SITES WEB ET SERVICES</h2>
      ...
      <h2>8. SIGNALER LE DÉCÈS D’UN UTILISATEUR</h2>

      <p>Nous ne sommes pas responsables des pratiques employées par les sites web et services liés à notre Service ou provenant
      ...
      <p>En cas de décès d’une personne qui utilise U'Connect, contactez l'IPI. Dans une telle situation, nous communiquons généralement
          par e-mail. Si nous avons besoin de renseignements supplémentaires, nous vous contacterons donc à l’adresse e-mail
          indiquée dans votre demande.</p>

      <h2>10. MODIFICATIONS DE LA POLITIQUE DE CONFIDENTIALITÉ</h2>

      <p>U'Connect se réserve le droit de modifier ou de mettre à jour de temps à autre la présente Politique de confidentialité.
          ...
          présente Politique de confidentialité, vous signifiez votre acceptation de ces modifications.</p>

      <p> © 2017 U'Connect, Inc. </p>
